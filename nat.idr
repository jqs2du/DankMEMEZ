...
{-evenb (S r) = evenb (S (S t)) = evenb t = evenb (S (S O)) = evenb O

= true. In the process outlined above, idris evaluates the evenb

function application expression by simplifying the argument all the

way down untill it reaches either evenb O or evenb (S O)
